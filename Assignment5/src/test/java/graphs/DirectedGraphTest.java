...
class DirectedGraphTest {
    ...
    void checkAddEdge() {
        ...
        assertTrue(africa.addEdge(new Country("MO"), new Country("AL"), 200),
                "New countries should be added as part of adding an edge");
        ...
        assertFalse(africa.addEdge(new Country("MO"), new Country("AL"), 300),
                "Only one directed edge per from-country and to-country can be added");
        ...
        assertFalse(africa.addEdge("MO", "XX", 300),
                "No edge can be added if one of the country id's doesn't match a country");
    ...
    void checkDFSearch() {
        ...
        assertSame(europe.getVertexById("LUX"), path.getVertices().stream().reduce((c1,c2)->c2).get(),
